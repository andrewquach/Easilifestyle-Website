...
if(Mage::getStoreConfig('fontis_wysiwyg/general/enable_uploads'))
{
    $Config['Enabled'] = true;
}
else
...
$userFilesPath = str_replace('//', '/', '/'.$magentoBase."/$uploadPath/");
$Config['UserFilesPath'] = $userFilesPath;
...
$Config['UserFilesAbsolutePath'] = Mage::getBaseDir()."/$uploadPath/" ;
