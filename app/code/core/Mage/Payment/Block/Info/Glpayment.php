...
class Mage_Payment_Block_Info_Glpayment extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/glpayment.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/glpayment.phtml');
        return $this->toHtml();
    }
