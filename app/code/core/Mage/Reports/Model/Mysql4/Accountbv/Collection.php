 ...
 */
class Mage_Reports_Model_Mysql4_Accountbv_Collection extends Vits_Ambassador_Model_Mysql4_Groupbv_Collection 
{
    /**
 	...
 	public function addOrderedQty($from = '', $to = '')
    {
        ...
        if(isset($session_data['child_bv_report']))
        {
        	$condition .= ' AND customer_id = '.$session_data['child_bv_report'].' ';
        }
        else 
        {
