...
class Mage_Reports_Model_Mysql4_Product_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection
{
    ...
    /**********************USEZ*****************************/
public function addOrderedQtySeller($from = '', $to = '',$seller_id = 0)
    {
        ...
        $this->getSelect()->reset()->from(
            ...
            array('ordered_qty' => "SUM(order_items.{$qtyOrderedFieldName})" ,'total' => "SUM(order_items.row_total)")
        );
         /*$this->getSelect()->reset()->from(
            array('order_items' => $qtyOrderedTableName),
            array('total' => "SUM(order_items.row_total)")
        );*/
        ...
        $this->getSelect()
            ->joinInner(array('e' => $this->getProductEntityTableName()),
             ...
             ->joinInner(array('c' => 'usez_catalog_product_entity_varchar'),
                "e.entity_id = c.entity_id  AND c.value = {$seller_id}")
            ->group('e.entity_id')
