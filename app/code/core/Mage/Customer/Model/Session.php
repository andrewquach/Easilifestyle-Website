...
class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    /**
     * ********************************************
     * Ham dung de lay mot chuoi ki tu ngau nhien voi chieu dai $length
     * @param unknown_type $length
     * @return chuoi ky tu ngau nhien
     */
    public function getRandomString($length=null) {
		$bank = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890';
		$result = '';
		while ( $length > 0 ) {
