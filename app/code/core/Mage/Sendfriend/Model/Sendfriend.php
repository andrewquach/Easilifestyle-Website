...
class Mage_Sendfriend_Model_Sendfriend extends Mage_Core_Model_Abstract
{
    ...
    public function send()
    {
     	...
     	$parent = '';
        if($customer->getUserRole() == 'ambassador' || $customer->getUserRole() == 'seniorambassador')
        {
	        $parent = '?parent='.$customer->getUsername();
        }
