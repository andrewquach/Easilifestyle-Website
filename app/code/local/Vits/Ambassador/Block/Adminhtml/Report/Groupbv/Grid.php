 ...
 */
class Vits_Ambassador_Block_Adminhtml_Report_Groupbv_Grid extends Vits_Ambassador_Block_Adminhtml_Report_Grid
{
    /**
     * Sub report size
     *
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getCollection()
            ->initReport('reports/groupbv_collection');
        return $this;
    }
    ...
    protected function _prepareColumns()
    {
       /* $this->addColumn('customer_id', array(
        ...
        $this->addExportType('*/*/exportGroupbvCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportGroupbvExcel', Mage::helper('reports')->__('Excel'));
