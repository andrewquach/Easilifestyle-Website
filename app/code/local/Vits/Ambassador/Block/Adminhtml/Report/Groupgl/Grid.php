 ...
 */
class Vits_Ambassador_Block_Adminhtml_Report_Groupgl_Grid extends Vits_Ambassador_Block_Adminhtml_Report_Grid
{
    /**
     * Sub report size
     *
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getCollection()
            ->initReport('reports/groupgl_collection');
        return $this;
    }
    ...
    protected function _prepareColumns()
    {
       /* $this->addColumn('customer_id', array(
        ...
        $this->addColumn('gl', array(
            'header'    =>Mage::helper('reports')->__('EL'),
            'width'     =>'120px',
            'align'     =>'right',
            'index'     =>'gl',
            'total'     =>'sum',
        ...
        $this->addExportType('*/*/exportGroupglCsv', Mage::helper('reports')->__('CSV'));
        $this->addExportType('*/*/exportGroupglExcel', Mage::helper('reports')->__('Excel'));
