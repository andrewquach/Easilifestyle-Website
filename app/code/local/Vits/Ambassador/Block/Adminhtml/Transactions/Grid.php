 ...
 */
class Vits_Ambassador_Block_Adminhtml_Report_Transactions_Grid extends Vits_Ambassador_Block_Adminhtml_Report_Grid
{
    /**
     * Sub report size
     *
    ...
    protected function _prepareCollection()
    {
        ...
        $this->getCollection()
            ->initReport('reports/transactions_collection');
        return $this;
    }
       ...
       /* $this->addColumn('customer_firstname', array(
        ...
        $this->addColumn('customer_lastname', array(
         ...
         $this->addColumn('transactions_time', array(
            'header'    =>Mage::helper('reports')->__('Transaction Time'),
            'index'     =>'transactions_time',
         	'type'		=>'date',
         	'format'	=> 'dd/MM/yyyy'
        ));
        $this->addColumn('type', array(
            'header'    =>Mage::helper('reports')->__('Transaction Type'),
            'index'     =>'type'
        ));
         $this->addColumn('amount', array(
            'header'    =>Mage::helper('reports')->__('Balancing'),
            'index'     =>'amount',
         	 'total'     =>'sum',
            'type'      =>'currency',
