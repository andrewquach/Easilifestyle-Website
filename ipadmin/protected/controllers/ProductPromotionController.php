...
class ProductPromotionController extends Controller
{
	...
	public function actionIndex($product)
	{
		if(isset($_POST['ProductPromotion']))
		{
			...
			$model->setAttributes($_POST['ProductPromotion'], false);
		...
		$model=new ProductPromotion('search');
	...
	{
		$model=ProductPromotion::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='product-promotion-form')
		{
